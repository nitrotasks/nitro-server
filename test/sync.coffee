...
describe 'Sync API', ->
  ...
  it 'should add lists and tasks', ->
    ...
    lists['s-0'].name.should.equal 'List 1'
    lists['s-1'].name.should.equal 'List 2'
    lists['s-2'].name.should.equal 'List 3'
    ...
    tasks['s-0'].name.should.equal 'Task 1'
    tasks['s-1'].name.should.equal 'Task 2'
    tasks['s-2'].name.should.equal 'Task 3'

    lists['s-0'].tasks.should.eql ['s-0', 's-1', 's-2']
  ...
  it 'should handle task and list updates', ->
    ...
    tasks = sync.user.data(TASK)
    tasks['s-0'].name.should.equal 'Task 1 has been renamed'
    tasks['s-1'].name.should.equal 'Task 2 has been renamed'
    tasks['s-2'].name.should.equal 'Task 3 has been renamed'
    ...
    # Check names have been updated
    lists = sync.user.data(LIST)
    lists['s-0'].name.should.equal 'List 1 has been renamed'
    lists['s-1'].name.should.equal 'List 2 has been renamed'
    lists['s-2'].name.should.equal 'List 3 has been renamed'
  ...
  it 'should handle task and list destruction', ->
    ...
    tasks = sync.user.data(TASK)
    tasks['s-0'].should.have.keys 'deleted', 'id'
    tasks['s-1'].should.have.keys 'deleted', 'id'
    tasks['s-2'].should.have.keys 'deleted', 'id'
    ...
    lists['s-0'].should.have.keys 'deleted', 'id'
    lists['s-1'].should.have.keys 'deleted', 'id'
    lists['s-2'].should.have.keys 'deleted', 'id'
