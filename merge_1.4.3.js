legacy_mergeDB = function(server, client, callback, version) {

	msg("Running legacy sync")
	...
	msg("CLIENT")
	legacy_cleanDB(client)
	msg("SERVER")
	legacy_cleanDB(server)
	...
	// Hidden lists
	for(var i = 0; i < server.lists.items.length; i++) {
