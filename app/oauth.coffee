...
services =
  ubuntu:
    ...
    oauth: new OAuth(
      ...
      "1.0", "http://sync.nitrotasks.com/oauth/callback?service=ubuntu", "PLAINTEXT"
    )
  dropbox:
    ...
    oauth: new OAuth(
      ...
      "1.0", "http://sync.nitrotasks.com/oauth/callback?service=dropbox", "PLAINTEXT"
    )
  google:
    ...
    oauth: new OAuth(
      ...
      "anonymous", "anonymous",
      "1.0A", "http://sync.nitrotasks.com/oauth/callback", "HMAC-SHA1"
    )
